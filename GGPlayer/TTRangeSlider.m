...
@property (nonatomic, strong) CALayer *sliderLineCover;
...
- (void)layoutSubviews {
    ...
    self.sliderLineCover.frame = CGRectMake(lineLeftSide.x, lineLeftSide.y, leftHandleCenter.x - 15, 1);
...
- (BOOL)beginTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event {
    ...
    if (CGRectContainsPoint(CGRectInset(self.leftHandle.frame, HANDLE_TOUCH_AREA_EXPANSION, HANDLE_TOUCH_AREA_EXPANSION), gesturePressLocation))
    {
...
-(void)setThumbColor:(UIColor *)thumbColor{
    [self.leftHandle setBackgroundColor:thumbColor.CGColor];
}
